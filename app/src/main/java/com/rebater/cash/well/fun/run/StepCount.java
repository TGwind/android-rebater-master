...
public class StepCount implements StepCountListener {
    ...
    private com.rebater.cash.well.fun.run.StepDetector stepDetector;//传感器SensorEventListener子类实例

    public StepCount() {
        stepDetector = new com.rebater.cash.well.fun.run.StepDetector();
...
//        notifyListener();
    ...
    public com.rebater.cash.well.fun.run.StepDetector getStepDetector(){
        return stepDetector;
    }
